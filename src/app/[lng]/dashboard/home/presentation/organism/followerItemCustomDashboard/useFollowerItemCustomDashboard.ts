...
import { FollowerItemCustomInputDashboard, FollowerItemCustomDashboardProps } from './FollowerItemCustomDashboardProps';
...
const useFollowerItemCustom = (lng: LanguagesType,initialForm:FollowerItemCustomInputDashboard = '', followerItem: FollowerItemCustomDashboardProps) => {
  const [input, setInput] = useState<FollowerItemCustomInputDashboard>(initialForm);
